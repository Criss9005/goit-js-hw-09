...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (timeMs > 0) btn.disabled = false;
        else (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
...
const fp = (0, _flatpickrDefault.default)(input, options);
...
},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
